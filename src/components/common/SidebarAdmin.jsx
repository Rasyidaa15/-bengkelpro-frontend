  ...
  const menuGroups = [
    {
      ...
      items: [
        ...
        { id: 'users', icon: <Users size={20} />, label: 'User' },
        { id: 'products', icon: <Package size={20} />, label: 'Produk' },
        { id: 'categories', icon: <Tag size={20} />, label: 'Kategori' },
        { id: 'suppliers', icon: <Truck size={20} />, label: 'Supplier' },
    ...
    },
    {
      label: 'TRANSAKSI',
      items: [
        { id: 'orders', icon: <ShoppingBag size={20} />, label: 'Transaksi' },
